...
The new concept design, also known as "concepts lite", aims to make generic code
type-checkable at declaration time, easier to understand and implement, and to
provide an escape hatch for generic code. Old code with unconstrained generic
parameters will continue to work. For more details, read the
`RFC #168 <https://github.com/nim-lang/RFCs/issues/168>`_.
...
right kind of mutability access.
